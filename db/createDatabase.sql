...
ALTER TABLE NEWS_POST AUTO_INCREMENT = 101;
...
ALTER TABLE TICKET AUTO_INCREMENT = 101;
...
CREATE TABLE COMMENT (
    ...
    CONSTRAINT FK_COMMENT_TICKET_ID FOREIGN KEY (TICKET_ID) REFERENCES TICKET (ID)
);
