                    ...
                    <a class="nav-link active dropdown-toggle" aria-current="page" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <?php
                            if (isset($_SESSION["user"])) {
                                ...
                                echo "User <img src='icon/person-circle.svg' class='icon' alt='Person-Icon' />";
                            }
                        ?>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                        <?php
                            if (isset($_SESSION["user"])) {
                                ...
                                echo "<li><a class='dropdown-item' href='registration.php'>Registierung <img src='icon/key-fill.svg' class='icon' alt='Key-Icon' /></a></li>";
                            }
                        ?>
                    </ul>
                </li>
